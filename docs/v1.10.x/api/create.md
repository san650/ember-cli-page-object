...
* [click](/docs/v1.10.x/api/clickable)
* [clickOn](/docs/v1.10.x/api/click-on-text)
* [contains](/docs/v1.10.x/api/contains)
* [fillIn](/docs/v1.10.x/api/fillable)
* [isVisible](/docs/v1.10.x/api/is-visible)
* [isHidden](/docs/v1.10.x/api/is-hidden)
* [select](/docs/v1.10.x/api/selectable)
* [text](/docs/v1.10.x/api/text)
