...
In `v0.x` we deprecated the `component` function. On `v1.0` we
...
options on the documentation [site](http://ember-cli-page-object.js.org/docs/v1.0.x/options)).
...
property [here](http://ember-cli-page-object.js.org/docs/v1.0.x/api/queries#text).
