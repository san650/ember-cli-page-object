...
In v0.x, when you defined a query or predicate on a page object, you needed to call it as a method with parens (`()`). Now they are accessed as object properties, without parens. You can see examples in the docs for [queries](/docs/v1.1.x/api/queries) and [predicates](/docs/v1.1.x/api/predicates).
